        ...
        <div className='w-full'>
            ...
            <div className='w-16 h-16 md:w-32 md:h-32'>
              ...
              <div className='flex flex-col justify-center'>
                <p className=' md:text-2xl tracking-wider  flex gap-1 items-center text-md font-bold text-primary-lowercase'>{user.userName.replaceAll(' ', '')}
            ...
            <div>
                <div className='flex gap-10 mb-10 mt-10 border-b-2 border-gray-200 bg-hite w-full'>
